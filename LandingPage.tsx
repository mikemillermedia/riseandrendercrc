...
import { 
  Star, CheckCircle2, TrendingUp, Video, Scissors, Share2, Palette, Clock, 
  Calculator, ArrowRight, PlayCircle, Image as ImageIcon, Plus, Minus, FileText, 
  Headphones, Monitor, Radio, Camera, Crown 
} from 'lucide-react';
...
const CombinedPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // --- NATIVE SEO LOGIC ---
    document.title = "Rise & Render | Premium Video Podcasting Studio & Pricing";
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#0a0a0a] text-[#F5F5F0] font-sans flex flex-col overflow-x-hidden">
      ...
      <motion.nav 
        ...
        className="fixed top-0 left-0 w-full z-50 p-6 md:p-12 flex justify-between items-center"
      >
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={18} className="text-[#ff4d00] fill-[#ff4d00]" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <p className="text-white/50 text-[10px] font-medium">Verified Google Review</p>
                      </div>
                    </div>
                  </div>
                </div>

                <div className="hidden lg:flex flex-col items-center justify-center p-6 border-l border-white/10 ml-2 pl-8 shrink-0">
                  <p className="text-white/40 text-[9px] font-bold uppercase tracking-widest mb-3">Ready to level up?</p>
                  <button 
                    onClick={scrollToPricing}
                    className="bg-transparent hover:bg-white text-white hover:text-black border border-white px-5 py-2.5 rounded-xl font-bold uppercase tracking-widest text-[10px] transition-all"
                  >
                    View Pricing
                  </button>
                </div>
      ...
      <div id="pricing-section" className="relative z-30 bg-[#0a0a0a] pt-10">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none [transform:translateZ(0)]">
          ...
          <motion.div
            ...
            className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] mix-blend-screen opacity-50"
          >
            <div className="absolute top-[10%] left-[10%] w-[80%] h-[80%] bg-[#F5F5F0]/5 rounded-full filter blur-[180px]" />
          </motion.div>
        </div>
                    ...
                    return (
                      <motion.div
                        ...
                        className={`cursor-pointer p-6 rounded-3xl border backdrop-blur-sm transition-all duration-300 flex flex-col justify-between ${
                          ...
                          : 'bg-[#131313]/80 border-white/10 hover:border-white/20'
                        }`}
                      >
        ...
        <motion.footer 
          ...
          className="relative z-50 w-full p-6 md:p-12 pb-8 border-t border-white/5 bg-[#0a0a0a]"
        >
      ...
      {showBackToTop && (
        <button 
          ...
          className="fixed bottom-6 left-6 z-50 bg-white/10 hover:bg-[#ff4d00] text-white p-3 rounded-full transition-all shadow-xl backdrop-blur-md border border-white/10"
        >
