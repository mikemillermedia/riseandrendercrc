...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] text-[#F5F5F0]">
      ...
      <section className="py-32 bg-[#131313] text-[#F5F5F0] relative overflow-hidden mt-20">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-5xl md:text-7xl font-black mb-12 uppercase tracking-tighter">The Vision <br/><span className="text-[#ff4d00]">Behind It</span></h2>
              <div className="space-y-6 text-xl text-[#F5F5F0]/70 leading-relaxed">
                <p>
                ...
                <p className="font-medium text-[#F5F5F0] border-l-[4px] border-[#ff4d00] pl-6 py-2 mt-8 bg-white/5 rounded-r-xl">
            ...
            <div className="relative mt-10 xl:mt-0">
              <div className="aspect-[4/5] rounded-[3rem] overflow-hidden border border-[#F5F5F0]/10 relative shadow-2xl max-w-lg mx-auto xl:ml-auto">
                <img 
                  src={mikeMillerImage} 
      ...
      <section className="py-32 bg-[#0a0a0a] text-[#F5F5F0] relative overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-6">
            <div className="bg-[#131313] p-10 rounded-[2rem] border border-[#F5F5F0]/5 relative flex flex-col justify-between shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
              ...
              <div>
                <p className="text-lg font-bold text-white">— Damon F.</p>
