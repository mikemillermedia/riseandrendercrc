          ...
          <div className="mt-32 mb-12 max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter">
                Session <span className="text-[#ff4d00]">Pricing</span>
              </h2>
              <p className="text-xl text-[#131313]/70 mt-4 font-medium">Simple hourly rates. Premium quality.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 items-stretch max-w-5xl mx-auto">
              
              {/* Left Card: Power Hour */}
              <div className="bg-[#A5A9B0] rounded-[2rem] md:rounded-r-none p-10 text-white flex flex-col items-center shadow-lg relative z-0">
                <div className="flex items-start mb-2">
                  <span className="text-[#ff4d00] text-3xl font-bold mt-2 mr-1">$</span>
                  <span className="text-6xl font-black tracking-tighter">150</span>
                </div>
                <p className="text-white font-bold mb-6 tracking-wide">/ hour</p>
                <div className="bg-[#ff4d00] text-white font-black py-2.5 px-8 rounded-full mb-10 uppercase tracking-widest text-sm shadow-[0_0_15px_rgba(255,77,0,0.3)]">
                  Power Hour
                </div>
                <ul className="space-y-4 w-full mt-auto">
                  {['1 Hour Recording Time', '4K Camera Recording', 'Up to 4 Microphones', 'Cinematic Lighting Setup', 'Raw Video & Audio Files', 'Choose Studio Setup'].map((feat, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm font-semibold">
                      <Check className="text-[#ff4d00] w-5 h-5 flex-shrink-0" strokeWidth={3} />
                      {feat}
                    </li>
                  ))}
                </ul>
              ...
              {/* Center Card: Batch Day (Highlighted) */}
              <div className="bg-[#282E38] rounded-[2rem] p-12 text-white flex flex-col items-center shadow-2xl relative z-10 md:-my-6 md:scale-105 border-t-4 border-[#ff4d00]">
                <div className="flex items-start mb-2">
                  <span className="text-[#ff4d00] text-3xl font-bold mt-2 mr-1">$</span>
                  <span className="text-7xl font-black tracking-tighter">500</span>
                </div>
                <p className="text-[#F5F5F0]/70 font-bold mb-6 tracking-wide">/ 4 hours</p>
                <div className="bg-[#ff4d00] text-white font-black py-2.5 px-8 rounded-full mb-10 uppercase tracking-widest text-sm shadow-[0_0_15px_rgba(255,77,0,0.3)]">
                  Batch Day
                </div>
                <ul className="space-y-4 w-full mt-auto">
                  {['4 Hours Recording Time', 'Record Multiple Episodes', '4K Camera Recording', 'Up to 4 Microphones', 'Cinematic Lighting Setup', 'Raw Video & Audio Files', 'Choose Studio Setup'].map((feat, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm font-semibold">
                      <Check className="text-[#ff4d00] w-5 h-5 flex-shrink-0" strokeWidth={3} />
                      {feat}
                    </li>
              ...
              {/* Right Card: Full Production */}
              <div className="bg-[#A5A9B0] rounded-[2rem] md:rounded-l-none p-10 text-white flex flex-col items-center shadow-lg relative z-0">
                <div className="flex items-start mb-2">
                  <span className="text-[#ff4d00] text-3xl font-bold mt-2 mr-1"></span>
                  <span className="text-5xl font-black tracking-tighter mt-3">Custom</span>
                </div>
                <p className="text-white font-bold mb-6 tracking-wide">Full Production</p>
                <div className="bg-[#ff4d00] text-white font-black py-2.5 px-8 rounded-full mb-10 uppercase tracking-widest text-sm shadow-[0_0_15px_rgba(255,77,0,0.3)]">
                  Consultation
                </div>
                <ul className="space-y-4 w-full mt-auto">
                  {['Professional Editing', 'Multiple Short-Form Clips', 'Social Media Optimization', 'Branding Support', 'Social Media Marketing', 'Strategic Discovery Call'].map((feat, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm font-semibold">
                      <Check className="text-[#ff4d00] w-5 h-5 flex-shrink-0" strokeWidth={3} />
                      {feat}
                    </li>
